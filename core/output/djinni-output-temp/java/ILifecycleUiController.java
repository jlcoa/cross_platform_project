...
public abstract class ILifecycleUiController {
    ...
    public abstract RAccountResponse getAccountInfo();
    ...
    private static final class CppProxy extends ILifecycleUiController
    {
        ...
        @Override
        public RAccountResponse getAccountInfo()
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            return native_getAccountInfo(this.nativeRef);
        }
        private native RAccountResponse native_getAccountInfo(long _nativeRef);
    }
}
