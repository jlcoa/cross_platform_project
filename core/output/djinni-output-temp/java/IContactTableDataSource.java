...
/**# contact */
public abstract class IContactTableDataSource {
    public abstract int numberOfSections();

    public abstract int numberOfRowsInSection(int section);

    public abstract RContact objectAt(int section, int row);

    private static final class CppProxy extends IContactTableDataSource
    {
        ...
        @Override
        public RContact objectAt(int section, int row)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            return native_objectAt(this.nativeRef, section, row);
        }
        private native RContact native_objectAt(long _nativeRef, int section, int row);
    }
}
