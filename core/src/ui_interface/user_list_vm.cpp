...
#include <iostream>
#include <thread>
using core_gen::UserListVmObserver;
using core_gen::UserListVmCell;
...
UserListVmHandle::_notify_new_data() {
    ...
    optional<vector<core_gen::ListChange>> diff;
    ...
    if (prev_rows) {
        ...
        vector<core_gen::ListChange> final_diff;
