...
EventLoopRef::EventLoopRef(shared_ptr<core_gen::EventLoop> loop) : m_loop {std::move(loop)} {}
...
EventLoopCpp::EventLoopCpp(const shared_ptr<core_gen::ThreadLauncher> & launcher) : m_stop(false), m_done(false) {
