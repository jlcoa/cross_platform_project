...
namespace core { namespace sqlite {
...
std::ostream& operator <<(std::ostream& os, const core::sqlite::Value& v);
std::ostream& operator <<(std::ostream& os, const vector<core::sqlite::Value>& v);
